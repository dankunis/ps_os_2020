...
simulation_data_t* read_simulation_data(char* input_file) {
	...
	data->num_processes = match_lines(fp, NULL);
...
void print_simulation_data(FILE* out, simulation_data_t* data) {
...
void print_schedule(FILE* out, schedule_t sched, simulation_data_t* data) {
